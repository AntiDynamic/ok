...
import { registerUser, signInWithGoogle, clearError } from '../features/auth/authSlice';
...
const Register = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await dispatch(registerUser({ email, password, displayName, userType }));
      navigate('/dashboard');
    } catch (error) {
          ...
          <div className="flex items-center justify-center">
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="user-type-customer" className="ml-2 block text-sm text-gray-900">
                  I'm a Customer
                </label>
              </div>
              <div className="flex items-center">
                <input
                  id="user-type-provider"
                  name="userType"
                  type="radio"
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                />
                <label htmlFor="user-type-provider" className="ml-2 block text-sm text-gray-900">
